...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/make-object-immutable/](https://leetcode.com/problems/make-object-immutable/)
- **Premium:** Yes
...
2. Recursively use proxy so that the user of the object is only able to access a proxy object.
3. Override how set works. It should throw the correct error instead of actually setting a value.
