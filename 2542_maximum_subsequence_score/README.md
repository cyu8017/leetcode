...
For chosen indices `i_{0}`, `i_{1}`, ..., `i_{k - 1}`, your **score** is defined as:

- The sum of the selected elements from `nums1` multiplied with the **minimum** of the selected elements from `nums2`.

	- It can defined simply as: `(nums1[i_{0}] + nums1[i_{1}] +...+ nums1[i_{k - 1}]) * min(nums2[i_{0}] , nums2[i_{1}], ... ,nums2[i_{k - 1}])`.
