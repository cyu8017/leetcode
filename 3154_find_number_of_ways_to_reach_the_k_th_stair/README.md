...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/find-number-of-ways-to-reach-the-k-th-stair/](https://leetcode.com/problems/find-number-of-ways-to-reach-the-k-th-stair/)
...
1. On using `x` operations of the second type and `y` operations of the first type, the stair `2^{x} - y` is reached.
...
3. Using combinatorics, we have ^{x + 1}C_{y} number of ways to select the positions of second operations.
