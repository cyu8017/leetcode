...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/minimum-time-to-transport-all-individuals/](https://leetcode.com/problems/minimum-time-to-transport-all-individuals/)
...
2. The states are `mask` of people left and `current_stage`.
3. The states form a cycle.
4. Consider the transitions as edges and the entire DP problem as a graph; all edge weights are positive.
5. We can use Dijkstra's algorithm.
