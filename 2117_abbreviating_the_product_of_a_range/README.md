...
```
... where  denotes the **first** 5 digits of the product, and  denotes the **last** 5 digits of the product **after** removing all trailing zeros. If d , we keep it unchanged.
