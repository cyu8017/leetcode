...
You are also given a 2D integer array `queries` of length `q`, where each `queries[i] = [ind_{i}, val_{i}]` indicates that you should update `nums[ind_{i}]` to `val_{i}`.
