...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/find-active-users/](https://leetcode.com/problems/find-active-users/)
- **Premium:** Yes
- **Tags:** database
...
- User with user_id 6 has two transaction his first transaction was on 2021-09-10 and second transation was on 2021-09-14. The distance between the first and second transactions date is  7 days. So he is not an active user.
