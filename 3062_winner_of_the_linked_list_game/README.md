...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/winner-of-the-linked-list-game/](https://leetcode.com/problems/winner-of-the-linked-list-game/)
- **Premium:** Yes
- **Tags:** linked-list
...
1. Traverse linked list and try to find pairs.
2. For each team, keep the number of its winning games in a variable.
3. Compare the winning variables and find the answer.
