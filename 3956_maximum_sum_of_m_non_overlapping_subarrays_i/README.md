...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/maximum-sum-of-m-non-overlapping-subarrays-i/](https://leetcode.com/problems/maximum-sum-of-m-non-overlapping-subarrays-i/)
...
2. A subarray ending at `i` and starting at `j` contributes `prefix[i] - prefix[j]`, where `l <= i - j <= r`.
