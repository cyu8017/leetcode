...
1. What if you think of a tree hierarchy for the files?.
2. A path is a node in the tree.
3. Use a hash table to store the valid paths along with their values.
