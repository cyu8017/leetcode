...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/valid-elements-in-an-array/](https://leetcode.com/problems/valid-elements-in-an-array/)
- **Tags:** array
...
1. Precompute the maximum left and right for each index.
2. The first and last are always valid.
