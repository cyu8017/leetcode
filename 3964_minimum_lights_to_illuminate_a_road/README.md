...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/minimum-lights-to-illuminate-a-road/](https://leetcode.com/problems/minimum-lights-to-illuminate-a-road/)
...
1. First mark all positions already visible from the existing working bulbs.
2. Then scan the road from left to right. Whenever you find the first invisible position `i`, install a new bulb as far right as possible while still covering `i`.
3. Since each additional bulb covers distance 1, the best position is usually `i + 1`, unless it goes out of bounds. After placing it, skip all positions it covers.
