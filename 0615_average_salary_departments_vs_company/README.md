...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/average-salary-departments-vs-company/](https://leetcode.com/problems/average-salary-departments-vs-company/)
- **Premium:** Yes
- **Tags:** database
...
The average salary of department '2' is (6000 + 10000)/2 = 8000, which is the average of employee_id '2' and '3'. So the comparison result is 'lower' since 8000
