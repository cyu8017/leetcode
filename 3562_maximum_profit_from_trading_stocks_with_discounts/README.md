...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/maximum-profit-from-trading-stocks-with-discounts/](https://leetcode.com/problems/maximum-profit-from-trading-stocks-with-discounts/)
...
The company's hierarchy is represented by a 2D integer array `hierarchy`, where `hierarchy[i] = [u_{i}, v_{i}]` means that employee `u_{i}` is the direct boss of employee `v_{i}`.
