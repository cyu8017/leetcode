...
1. How can game theory help us solve this problem?
2. Think about the Sprague–Grundy theorem and the Colon Principle
3. The Grundy value of a node is the nim sum of the Grundy values of its children.
