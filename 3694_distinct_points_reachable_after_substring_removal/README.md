...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/distinct-points-reachable-after-substring-removal/](https://leetcode.com/problems/distinct-points-reachable-after-substring-removal/)
...
1. Use prefix sums for the `x`-coordinate and `y`-coordinate.
2. Using the prefix sum arrays, compute the `x`-coordinate and `y`-coordinate after removing a subarray of size `k`.
