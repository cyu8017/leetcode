...
1. Iterate over all substrings in `O(n * n)`.
2. For each substring, try to calculate the sum of the mapped values in `O(1)`.
3. To do the above, use a partial sum array.
