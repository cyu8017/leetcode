...
1. Think of using breadth-first search.
2. Use a BFS to find for each cell the time at which it will become flooded.
3. Another BFS then simulates your movement, taking into account information gathered by the first BFS.
