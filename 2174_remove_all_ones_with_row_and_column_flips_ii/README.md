...
1. With the given constraints, could a brute force solution pass?
2. What would a brute force solution look like?
3. We can try every single possibility of choosing to do an operation on a cell with a 1 or choosing to ignore it.
