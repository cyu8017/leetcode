...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/maximum-points-activated-with-one-addition/](https://leetcode.com/problems/maximum-points-activated-with-one-addition/)
- **Tags:** array, hash-table, union-find

## Problem

You are given a 2D integer array `points`, where `points[i] = [x_{i}, y_{i}]` represents the coordinates of the `i^{th}` point. All coordinates in `points` are **distinct**.
