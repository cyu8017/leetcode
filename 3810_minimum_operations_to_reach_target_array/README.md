...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/minimum-operations-to-reach-target-array/](https://leetcode.com/problems/minimum-operations-to-reach-target-array/)
...
2. The answer is the number of distinct values in `nums` among those positions.
