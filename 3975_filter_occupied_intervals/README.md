...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/filter-occupied-intervals/](https://leetcode.com/problems/filter-occupied-intervals/)
- **Tags:** array, sorting

## Problem

You are given a 2D integer array `occupiedIntervals`, where `occupiedIntervals[i] = [start_{i}, end_{i}]` represents a time interval during which you are occupied. Each interval starts at `start_{i}` and ends at `end_{i}`, **inclusive**. These intervals may **overlap**.
