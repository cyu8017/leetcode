...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/number-of-student-replacements/](https://leetcode.com/problems/number-of-student-replacements/)
- **Premium:** Yes
...
1. Iterate through the array from left to right, keeping track of the current best (minimum) rank.
2. Whenever you see an element strictly lower than your current best, update the best to that element and increment the replacement count.
