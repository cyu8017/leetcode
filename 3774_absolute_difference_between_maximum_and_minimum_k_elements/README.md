...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/absolute-difference-between-maximum-and-minimum-k-elements/](https://leetcode.com/problems/absolute-difference-between-maximum-and-minimum-k-elements/)
- **Tags:** array, sorting
...
1. Sort the array and find the difference between the first and last `k` values.
