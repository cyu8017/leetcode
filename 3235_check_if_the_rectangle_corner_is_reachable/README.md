...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/check-if-the-rectangle-corner-is-reachable/](https://leetcode.com/problems/check-if-the-rectangle-corner-is-reachable/)
- **Tags:** array, math, depth-first-search, breadth-first-search, union-find, geometry

## Problem

You are given two positive integers `xCorner` and `yCorner`, and a 2D array `circles`, where `circles[i] = [x_{i}, y_{i}, r_{i}]` denotes a circle with center at `(x_{i}, y_{i})` and radius `r_{i}`.
