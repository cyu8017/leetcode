...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/maximum-score-of-a-split/](https://leetcode.com/problems/maximum-score-of-a-split/)
...
1. Use prefix sum and suffix minimum arrays.
2. Precompute the prefix sums of `nums` and the suffix minimums for all valid split positions.
3. For each split index `i`, compute `score(i) = prefixSum(i) - suffixMin(i)` and keep track of the maximum value.
