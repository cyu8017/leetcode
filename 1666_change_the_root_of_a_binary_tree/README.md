...
1. Start traversing from the leaf. Always go up till you reach the root.
2. Change pointers as asked, make the current node's parent its left child, and make the left child the right one if needed.
