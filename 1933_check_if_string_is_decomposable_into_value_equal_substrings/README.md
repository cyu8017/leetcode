...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/check-if-string-is-decomposable-into-value-equal-substrings/](https://leetcode.com/problems/check-if-string-is-decomposable-into-value-equal-substrings/)
- **Premium:** Yes
- **Tags:** string
...
1. Keep looking for 3-equals, if you find a 3-equal, keep going. If you don't find a 3-equal, check if it is a 2-equal.
2. Make sure that it is the only 2-equal.
3. If it is neither a 3-equal nor a 2-equal, then it is impossible.
