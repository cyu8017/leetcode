...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/last-remaining-integer-after-alternating-deletion-operations/](https://leetcode.com/problems/last-remaining-integer-after-alternating-deletion-operations/)
- **Tags:** math, recursion
...
2. Maintain the start value, remaining length, and current direction using recursion.
3. Track the current direction (left or right) and update the start value based on the parity of the remaining length.
