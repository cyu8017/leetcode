...
[null,true,"third",null,"",false,true]
...
1. What data structure do you need to use for this problem?
2. Try using a Hash map, each table name will be the key, and the value will be an array of all rows.
