...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/largest-even-number/](https://leetcode.com/problems/largest-even-number/)
- **Tags:** string
...
1. A number ending with `'1'` is odd.
2. Find the last `'2'` in `s`. If none, return `""`. Otherwise return the prefix up to and including that `'2'`.
