...
export function numberOfPairs(nums1: any, nums2: any, queries: any): any {
    const blockSize = 225;
...
function rebuild(freq: any, nums2: any, b: any, blockSize: any, n: any): any {
    freq[b].clear();
...
function push(lazy: any, nums2: any, b: any, blockSize: any, n: any): any {
    if (lazy[b] !== 0) {
        const end = Math.min((b + 1) * blockSize, n);
