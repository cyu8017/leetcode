...
You are given a 2D integer array `intervals` where `intervals[i] = [left_{i}, right_{i}]` represents the **inclusive** interval `[left_{i}, right_{i}]`.
