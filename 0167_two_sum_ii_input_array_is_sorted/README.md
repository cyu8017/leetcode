...
**Output:** [1,2]
**Explanation:** The sum of 2 and 7 is 9. Therefore, index_{1} = 1, index_{2} = 2. We return [1, 2].
```
...
**Output:** [1,3]
**Explanation:** The sum of 2 and 4 is 6. Therefore index_{1} = 1, index_{2} = 3. We return [1, 3].
```
...
**Output:** [1,2]
**Explanation:** The sum of -1 and 0 is -1. Therefore index_{1} = 1, index_{2} = 2. We return [1, 2].
```
