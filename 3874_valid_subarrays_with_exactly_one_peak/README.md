...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/valid-subarrays-with-exactly-one-peak/](https://leetcode.com/problems/valid-subarrays-with-exactly-one-peak/)
- **Premium:** Yes
- **Tags:** array, math
...
1. Gather peak indices and find the boundaries where each is the only peak.
2. Calculate how far the left and right endpoints for each peak can extend under the constraints.
3. Sum the product of the possible left and right endpoints for each peak.
