...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/smallest-unique-subarray/](https://leetcode.com/problems/smallest-unique-subarray/)
- **Tags:** array, hash-table, binary-search, rolling-hash, suffix-array, hash-function
