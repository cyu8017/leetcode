...
1. Start from the beginning of the array `nums.at(0)`.
2. Do a binary search on the last index `last` such that `nums.at(0) == nums.at(last)`.
3. Continue this process until you get to the end of the array (`nums.size()`).
