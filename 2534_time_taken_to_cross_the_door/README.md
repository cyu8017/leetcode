...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/time-taken-to-cross-the-door/](https://leetcode.com/problems/time-taken-to-cross-the-door/)
- **Premium:** Yes
...
1. Use a queue to store the people who want to enter or exit and their corresponding times.
2. Simulate the process described in the statement and apply the 4 rules to the people crossing the door.
