...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/unique-email-groups/](https://leetcode.com/problems/unique-email-groups/)
- **Premium:** Yes
...
1. Simulate the normalization process as described, and use an unordered set (or set) to keep track of unique normalized email addresses.
