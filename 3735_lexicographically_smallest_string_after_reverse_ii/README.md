...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/lexicographically-smallest-string-after-reverse-ii/](https://leetcode.com/problems/lexicographically-smallest-string-after-reverse-ii/)
- **Premium:** Yes
- **Tags:** string, binary-search, rolling-hash, suffix-array, hash-function
...
1. Use binary search and hashing for faster lexicographically smaller comparisons
