...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/maximize-profit-from-task-assignment/](https://leetcode.com/problems/maximize-profit-from-task-assignment/)
- **Premium:** Yes
...
1. Use a hashmap to group the tasks by their required skill level `tasks[i][0]`
2. For each worker, assign the highest profit task from the hashmap that matches their exact skill requirement
3. Assign the task with the maximum profit among the unassigned tasks to the extra worker
