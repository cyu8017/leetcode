...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/limit-occurrences-in-sorted-array/](https://leetcode.com/problems/limit-occurrences-in-sorted-array/)
...
2. If the counter is currently more than `k`, ignore the current element.
