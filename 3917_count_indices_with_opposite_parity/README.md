...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/count-indices-with-opposite-parity/](https://leetcode.com/problems/count-indices-with-opposite-parity/)
- **Tags:** array
