...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/smallest-absent-positive-greater-than-average/](https://leetcode.com/problems/smallest-absent-positive-greater-than-average/)
...
1. Compute the average, set `x = floor(avg) + 1` (the smallest integer greater than the average).
2. Increment `x` until it's not in the array and return it.
