...
export function magicalSum(m: any, k: any, nums: any): any {
    const N = 31, MOD = 1000000007;
    const f = new Array(N).fill(0), g = new Array(N).fill(0);
    let inited = false;
    function qpow(a: any, kk: any): any {
        let res = 1n;
        ...
        inited = true;
    }    function comb(mm: any, nn: any): any {
    ...
    function dfs(i: any, j: any, kk: any, st: any): any {
