...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/smallest-subarray-to-sort-in-every-sliding-window/](https://leetcode.com/problems/smallest-subarray-to-sort-in-every-sliding-window/)
- **Premium:** Yes
