...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/winning-candidate/](https://leetcode.com/problems/winning-candidate/)
- **Premium:** Yes
- **Tags:** database
...
Each row of this table determines the candidate who got the i^{th} vote in the elections.
