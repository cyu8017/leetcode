...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/find-drivers-with-improved-fuel-efficiency/](https://leetcode.com/problems/find-drivers-with-improved-fuel-efficiency/)
- **Tags:** database
