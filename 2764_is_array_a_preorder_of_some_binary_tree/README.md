...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/is-array-a-preorder-of-some-binary-tree/](https://leetcode.com/problems/is-array-a-preorder-of-some-binary-tree/)
- **Premium:** Yes
...
1. Think of using the stack data structure.
2. Put the first node in the stack.
3. Iterate over the array and check if the node at the top of the stack is its parent; if it’s not, then pop the last element of the stack and check until you reach the parent of the current node in the array.
4. If the stack gets empty at any point, then the array is not the preorder.
