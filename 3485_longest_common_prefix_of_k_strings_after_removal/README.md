...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/longest-common-prefix-of-k-strings-after-removal/](https://leetcode.com/problems/longest-common-prefix-of-k-strings-after-removal/)
...
3. For each `arr[i]`, remove it from the trie and update the counts.
4. During evaluation, find the innermost node with at least `k` paths ending there.
