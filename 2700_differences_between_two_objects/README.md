...
1. Find the intersection of the keys/indices on the two arrays/objects.
2. Analyze the data structure recursively.
3. For each key in the intersection, omit if there are no differences in the leaves. Otherwise return the difference.
