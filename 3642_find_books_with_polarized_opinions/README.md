...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/find-books-with-polarized-opinions/](https://leetcode.com/problems/find-books-with-polarized-opinions/)
...
- To Kill a Mockingbird (book_id = 2): All ratings are 4-5, no low ratings (≤2)
		...
		- Pride and Prejudice (book_id = 4): Only 2 sessions (
