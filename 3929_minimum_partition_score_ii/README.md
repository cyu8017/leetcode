...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/minimum-partition-score-ii/](https://leetcode.com/problems/minimum-partition-score-ii/)
- **Premium:** Yes
- **Tags:** array, binary-search, dynamic-programming, prefix-sum
