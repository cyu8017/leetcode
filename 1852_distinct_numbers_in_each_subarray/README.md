...
1. Keep a frequency map of the elements in each window.
2. When the frequency of the element is 0, remove it from the map.
3. The answer to each window is the size of the map.
