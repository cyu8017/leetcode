...
function buildRateGraph(pairs: any, rates: any): any {
    const g = new Map();
    ...
    return g;
}function bellman(start: any, pairs: any, rates: any): any {
    ...
    return dist;
}export function maxAmount(initialCurrency: any, pairs1: any, rates1: any, pairs2: any, rates2: any): any {
