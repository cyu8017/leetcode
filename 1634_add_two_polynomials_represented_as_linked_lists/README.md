...
1. Process both linked lists at the same time
2. If the current power of the two heads is equal, add this power with the sum of the coefficients to the answer list.
3. If one head has a larger power, add this power to the answer list and move only this head.
