...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/count-fancy-numbers-in-a-range/](https://leetcode.com/problems/count-fancy-numbers-in-a-range/)
...
4. Answer = `cnt(r) - cnt(l - 1) + count(goods in [l, r]) - count(g in goods where l <= g <= r and sum(g) in good_sums)`.
