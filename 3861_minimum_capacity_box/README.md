...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/minimum-capacity-box/](https://leetcode.com/problems/minimum-capacity-box/)
- **Tags:** array
...
1. Iterate to find the minimum capacity >= `itemSize`, updating index only on strictly smaller finds.
2. Handle ties by keeping the earliest index.
3. Return `-1` if no valid box exists.
