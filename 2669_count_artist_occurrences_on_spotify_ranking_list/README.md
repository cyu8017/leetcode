...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/count-artist-occurrences-on-spotify-ranking-list/](https://leetcode.com/problems/count-artist-occurrences-on-spotify-ranking-list/)
- **Premium:** Yes
- **Tags:** database
