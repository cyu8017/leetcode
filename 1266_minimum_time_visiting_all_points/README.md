...
On a 2D plane, there are `n` points with integer coordinates `points[i] = [x_{i}, y_{i}]`. Return *the **minimum time** in seconds to visit all the points in the order given by *`points`.
