...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/longest-fibonacci-subarray/](https://leetcode.com/problems/longest-fibonacci-subarray/)
- **Tags:** array
...
1. Any subarray of `length <= 2` is valid. Start with length 2.
