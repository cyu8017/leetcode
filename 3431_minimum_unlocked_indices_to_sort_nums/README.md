...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/minimum-unlocked-indices-to-sort-nums/](https://leetcode.com/problems/minimum-unlocked-indices-to-sort-nums/)
- **Premium:** Yes
...
1. All positions between the first 2 and the last 1 should be unlocked.
2. All positions between the first 3 and the last 2 should be unlocked.
3. If the position of the first 3 is less than the position of the last 1, the answer is -1.
