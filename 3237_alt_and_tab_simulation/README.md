...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/alt-and-tab-simulation/](https://leetcode.com/problems/alt-and-tab-simulation/)
- **Premium:** Yes
...
1. Let’s answer the queries offline.
2. Start from the **last** query until you reach the first query.
3. Each time, append the value of that query to a `ans` array if it wasn’t already appended.
4. Then start from the **beginning** of `windows` and append to `ans` array if it wasn’t already appended.
