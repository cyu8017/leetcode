...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/maximum-subarray-sum-after-at-most-k-swaps/](https://leetcode.com/problems/maximum-subarray-sum-after-at-most-k-swaps/)
...
4. The marginal gains are non-increasing as `t` grows, so find the largest profitable `t <= k` and add its gain to the original subarray sum.
