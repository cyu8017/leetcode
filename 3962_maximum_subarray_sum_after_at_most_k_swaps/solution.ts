...
export function maxSubarraySum(nums: any, k: any): any {
        let n = nums.length;
        unique = nums.slice();
        unique.sort((a,b)=>a-b);
        let u = 0;
...
}export function add(count: any, sum: any, index: any, delta: any): any {
...
}export function queryCount(bit: any, index: any): any {
        let result = 0;
        for (; index > 0; index -= index & -index) result += bit[index];
        return result;
    
}export function querySum(bit: any, index: any): any {
        let result = 0;
        for (; index > 0; index -= index & -index) result += bit[index];
        return result;
    
}export function kth(bit: any, order: any): any {
        let index = 0, step = 1;
...
}export function sumSmallest(count: any, sum: any, amount: any): any {
...
}export function lowerBound(a: any, x: any): any {
