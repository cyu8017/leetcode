...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/minimum-generations-to-target-point/](https://leetcode.com/problems/minimum-generations-to-target-point/)
- **Tags:** array, hash-table, simulation

## Problem

You are given a 2D integer array `points` where `points[i] = [x_{i}, y_{i}, z_{i}]` represents a point in 3D space, and an integer array `target` representing a target point.
