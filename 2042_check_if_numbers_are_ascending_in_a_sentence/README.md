...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/check-if-numbers-are-ascending-in-a-sentence/](https://leetcode.com/problems/check-if-numbers-are-ascending-in-a-sentence/)
- **Tags:** string
