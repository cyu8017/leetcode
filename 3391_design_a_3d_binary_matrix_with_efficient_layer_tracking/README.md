...
1. Keep track of the number of 1’s on each matrix.
2. Use a data structure that allows to efficiently insert, delete or get the biggest pair on a list of pairs.
