...
1. Let's find for every user separately the websites he visited.
2. Consider all possible 3-sequences, find the number of distinct users who visited each of them.
3. How to check if some user visited some 3-sequence ?
4. Store for every user all the 3-sequence he visited.
