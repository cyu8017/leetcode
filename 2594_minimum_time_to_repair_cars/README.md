...
You are given an integer array `ranks` representing the **ranks** of some mechanics. ranks_{i} is the rank of the i^{th} mechanic. A mechanic with a rank `r` can repair n cars in `r * n^{2}` minutes.
