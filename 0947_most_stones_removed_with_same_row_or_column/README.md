...
Given an array `stones` of length `n` where `stones[i] = [x_{i}, y_{i}]` represents the location of the `i^{th}` stone, return *the largest possible number of stones that can be removed*.
