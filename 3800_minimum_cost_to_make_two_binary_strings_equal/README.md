...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/minimum-cost-to-make-two-binary-strings-equal/](https://leetcode.com/problems/minimum-cost-to-make-two-binary-strings-equal/)
- **Tags:** string, greedy
