...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/maximum-distance-between-unequal-words-in-array-ii/](https://leetcode.com/problems/maximum-distance-between-unequal-words-in-array-ii/)
- **Premium:** Yes
- **Tags:** array, string
...
1. Use two pointers
2. Fix the first word as `words[i]` and find the rightmost unequal `words[j]`
3. Fix the last word as `words[i]` and find the leftmost unequal `words[j]`
