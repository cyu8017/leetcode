...
You are given an array `points`, an integer `angle`, and your `location`, where `location = [pos_{x}, pos_{y}]` and `points[i] = [x_{i}, y_{i}]` both denote **integral coordinates** on the X-Y plane.
