...
function Edge(to: any, reverse: any): any {
    this.to = to; this.reverse = reverse;
}
function combine(minimum: any, maximum: any, count: any, base: any): any {
    if (count === 0) return base;
    return 2 * maximum - minimum + base;
}
export function minFinishTime(n: any, edges: any, baseTime: any): any {
