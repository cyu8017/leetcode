...
var largestMagicSquare = function(grid) {
    ...
    const rowSum = (row, colStart, colEnd) => rowPrefix[row][colEnd + 1] - rowPrefix[row][colStart];
    const colSum = (col, rowStart, rowEnd) => colPrefix[col][rowEnd + 1] - colPrefix[col][rowStart];
    const isMagic = (rowStart, colStart, size) => {
