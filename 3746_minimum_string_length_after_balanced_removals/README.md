...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/minimum-string-length-after-balanced-removals/](https://leetcode.com/problems/minimum-string-length-after-balanced-removals/)
...
1. Remove the longest possible balanced substring initially
2. Let the count of a's be `count_a` and the count of b's be `count_b`. Can we derive the final length from these?
3. The answer is `abs(count_a - count_b)`
