...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/maximum-alternating-sum-of-squares/](https://leetcode.com/problems/maximum-alternating-sum-of-squares/)
...
1. The score uses squares of values. The original signs of `nums` don't affect the squared terms.
