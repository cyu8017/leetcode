...
1. What if you think in a greedy approach?
2. The best apple to take in one step is the one with the smallest weight.
3. Sort the array and take apples with smaller weight first.
