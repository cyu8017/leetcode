...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/minimum-adjacent-swaps-to-alternate-parity/](https://leetcode.com/problems/minimum-adjacent-swaps-to-alternate-parity/)
- **Tags:** array, greedy
