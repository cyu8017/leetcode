...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/compare-sums-of-bitonic-parts/](https://leetcode.com/problems/compare-sums-of-bitonic-parts/)
- **Tags:** array
...
1. Find the peak (maximum element) in one pass.
2. Compute total sum, then derive ascending and descending sums using the peak index.
