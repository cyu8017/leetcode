...
1. Think of recursive methods.
2. Write a recursive function that gives a node of the tree and returns S[node].
3. Call the function above on the root of the tree and get k-th character of it.
