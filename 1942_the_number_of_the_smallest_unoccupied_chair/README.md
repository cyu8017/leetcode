...
You are given a **0-indexed** 2D integer array `times` where `times[i] = [arrival_{i}, leaving_{i}]`, indicating the arrival and leaving times of the `i^{th}` friend respectively, and an integer `targetFriend`. All arrival times are **distinct**.
