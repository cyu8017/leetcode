...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/alternating-groups-iii/](https://leetcode.com/problems/alternating-groups-iii/)
...
- `queries[i] = [1, size_{i}]`, determine the count of **alternating** groups with size `size_{i}`.

	- `queries[i] = [2, index_{i}, color_{i}]`, change `colors[index_{i}]` to `color_{i}`.
