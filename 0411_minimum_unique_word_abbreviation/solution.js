...
var minAbbreviation = function (target, dictionary) {
    ...
    const valid = (abbr) => matches(target, abbr) && words.every((word) => !matches(word, abbr));

    const dfs = (index, parts, skip) => {
...
module.exports = { minAbbreviation };
