...
- `nums1[i] = [id_{i}, val_{i}]` indicate that the number with the id `id_{i}` has a value equal to `val_{i}`.

	- `nums2[i] = [id_{i}, val_{i}]` indicate that the number with the id `id_{i}` has a value equal to `val_{i}`.
