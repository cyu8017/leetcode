...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/split-a-circular-linked-list/](https://leetcode.com/problems/split-a-circular-linked-list/)
- **Premium:** Yes
...
1. Do a while loop to calculate the size of the linked list.
2. Determine the size of the first half and create a new linked list in its size.
3. Do not forget that this half itself should be circular!
4. Use the previous hints for the second half.
