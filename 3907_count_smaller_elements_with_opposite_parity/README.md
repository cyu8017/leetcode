...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/count-smaller-elements-with-opposite-parity/](https://leetcode.com/problems/count-smaller-elements-with-opposite-parity/)
- **Premium:** Yes
...
1. Use a data structure to keep track of elements of different parities.
2. For the current index, query the data structure for elements to the right with different parity and a smaller value.
