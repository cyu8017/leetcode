...
- `SummaryRanges()` Initializes the object with an empty stream.
	...
	- `int[][] getIntervals()` Returns a summary of the integers in the stream currently as a list of disjoint intervals `[start_{i}, end_{i}]`. The answer should be sorted by `start_{i}`.
