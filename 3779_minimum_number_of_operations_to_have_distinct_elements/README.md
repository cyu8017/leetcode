...
1. Simulate the operations as described using a map that is initially filled.
2. While the map does not contain all distinct elements, delete the first three values using a pointer.
3. Repeat until the map contains all distinct elements or becomes empty.
