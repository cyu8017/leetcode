...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/find-the-degree-of-each-vertex/](https://leetcode.com/problems/find-the-degree-of-each-vertex/)
...
1. The degree of node `i` is the sum of row `i` in the matrix
