...
1. Check for a common prefix of the two arrays.
2. After this common prefix, there should be one array similar to the other but shifted by one.
3. If both arrays can be shifted, return -1.
