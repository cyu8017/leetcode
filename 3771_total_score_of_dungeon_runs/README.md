...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/total-score-of-dungeon-runs/](https://leetcode.com/problems/total-score-of-dungeon-runs/)
...
4. For each `j`, count the previous `i`s with `pref[i-1] < requirement[j] - hp + pref[j]` using binary search or an ordered data structure.
