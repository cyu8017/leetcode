...
## Approach
Use SQL aggregation/joining to maintain exactly the state needed by the problem. The implementation processes each state once (or once per relevant transition) and avoids redundant work.
