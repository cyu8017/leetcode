...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/complete-prime-number/](https://leetcode.com/problems/complete-prime-number/)
...
1. Check primality for all prefixes and all suffixes of `num` and return true only if every one is prime.
