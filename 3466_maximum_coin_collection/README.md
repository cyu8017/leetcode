...
2. Use dynamic programming with states: `dp[i][lane][rem]` = the maximum number of coins you can obtain when you are at mile `i` in the given `lane` with `rem` switches remaining.
