...
You are also given a **positive** integer `k` and a 2D integer array `points`, where `points[i] = [x_{i}, y_{i}]` represents the coordinate of a point lying on the **boundary** of the square.
