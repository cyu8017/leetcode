...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/sum-of-consecutive-subarrays/](https://leetcode.com/problems/sum-of-consecutive-subarrays/)
- **Premium:** Yes
...
2. Another approach would be a two-pointer.
3. Start from the first index and traverse until the last one.
4. At each step, store the sum of the suffix that forms a consecutive subarray.
5. Do the above for both +1 and -1 and add them up.
