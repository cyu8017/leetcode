...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/find-category-recommendation-pairs/](https://leetcode.com/problems/find-category-recommendation-pairs/)
- **Tags:** database
...
- Find all **category pairs** (where `category1`
**Input:**
