...
- **Difficulty:** Medium
- **LeetCode:** [https://leetcode.com/problems/maximum-manhattan-distance-after-all-moves/](https://leetcode.com/problems/maximum-manhattan-distance-after-all-moves/)
...
1. Count the net horizontal movement, net vertical movement, and the number of underscores.
2. Without underscores, the final distance is `abs(x) + abs(y)`.
3. Each underscore can always be chosen to increase the final Manhattan distance by 1, so add the number of underscores to the fixed-move distance.
