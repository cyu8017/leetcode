...
You are given a 2D integer array `squares`. Each `squares[i] = [x_{i}, y_{i}, l_{i}]` represents the coordinates of the bottom-left point and the side length of a square parallel to the x-axis.
