...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/number-of-effective-subsequences/](https://leetcode.com/problems/number-of-effective-subsequences/)
...
1. The bitwise OR is reduced if a bit is completely removed from the array OR.
2. To completely remove a bit, all of its occurrences must be removed from the array.
3. Count such subsets and apply inclusion-exclusion on the bits.
