...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/majority-frequency-characters/](https://leetcode.com/problems/majority-frequency-characters/)
...
1. Start by counting the frequency of each character in the string.
2. Group characters based on their frequencies.
3. Identify the group with the largest number of distinct characters.
4. If multiple groups tie, select the one with the higher frequency value.
5. Construct the answer string using all characters from that chosen group.
