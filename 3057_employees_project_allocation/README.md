...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/employees-project-allocation/](https://leetcode.com/problems/employees-project-allocation/)
- **Premium:** Yes
- **Tags:** database
...
Return t*he result table ordered by* `employee_id`, `project_id` *in **ascending** order.*
