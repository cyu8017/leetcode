...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/maximum-students-on-a-single-bench/](https://leetcode.com/problems/maximum-students-on-a-single-bench/)
- **Premium:** Yes
...
1. Use a hash table (or dictionary) to group students by their bench ID.
