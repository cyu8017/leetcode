...
- **Difficulty:** Easy
- **LeetCode:** [https://leetcode.com/problems/find-the-shortest-superstring-ii/](https://leetcode.com/problems/find-the-shortest-superstring-ii/)
- **Premium:** Yes
- **Tags:** string
...
1. Check for the maximum suffix of one string that matches a prefix of the other (in both directions) and merge accordingly.
