...
- **Difficulty:** Hard
- **LeetCode:** [https://leetcode.com/problems/maximum-elegance-of-a-k-length-subsequence/](https://leetcode.com/problems/maximum-elegance-of-a-k-length-subsequence/)
...
`items[i] = [profit_{i}, category_{i}]`, where `profit_{i}` and `category_{i}` denote the profit and category of the `i^{th}` item respectively.
